  ...
  <?php foreach ($posts as $post_id => $post): ?>
    <tr>
      ...
      <td><?php if ($post['resto']): ?>
        <a href="//boards.<?php echo L::d($board) ?>/<?php echo $board ?>/thread/<?php echo $post['resto'].'#p'.$post['no'] ?>">/<?php echo $board ?>/<?php echo $post['no'] ?></a>
      <?php else: ?>
        <a href="//boards.<?php echo L::d($board) ?>/<?php echo $board ?>/thread/<?php echo $post['no'] ?>">/<?php echo $board ?>/<?php echo $post['no'] ?> (OP)</a>
      <?php endif ?></td>
    </tr>
  <?php endforeach ?>
</tbody>
