...
class Login {
  ...
  private function setCookie($name, $value, $ttl = 0, $path = '', $domain = '', $secure = false, $http_only = false) {
    ...
    header("Set-Cookie: $name=$value; Path=$path;$max_age Domain=$domain; SameSite=None$flags", false);
  }
  ...
  public function do_login() {
    ...
    $cookie_ttl = $_SERVER['REQUEST_TIME'] + 12 * 30 * 24 * 3600;
    ...
    $this->setCookie('extra_path', $js_path, $cookie_ttl, '/', $domain, true);
  ...
  public function do_logout() {
    ...
    $this->setCookie('extra_path', '', $cookie_ttl, '/', $domain, true);
  ...
  public function channel_frame() {
    ...
    $this->setCookie('tptkn', '1', 0, '/login', '.4channel.org', true, false);
