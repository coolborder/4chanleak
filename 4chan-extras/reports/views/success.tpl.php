...
<head>
  ...
  <?php if ($this->redirect): ?><meta http-equiv="Refresh" content="1; url=<?php echo $this->redirect ?>" /><?php endif ?>
  <title>Success</title>
  <style type="text/css">
    body {
...
<body>
<div id="success"><?php if (isset($this->success_msg) && $this->success_msg): ?>
