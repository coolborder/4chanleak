...
<html <?php if ($this->isChannel) { echo 'data-channelpage'; } ?>>
<head>
  <meta charset="utf-8">
  ...
  <script type="text/javascript" src="/js/login.js?14"></script>
  <?php endif ?>
...
<?php if ($this->isLogged): ?>
  ...
  <a class="button btn-login" href="https://reports.4chan.org/" target="_top">Reports Home</a>
  <br><br>
